...
!function($) {
    ...
    Selectpicker.prototype = {
        ...
        createDropdown: function() {
            ...
            var drop = '<div style="margin: 0; height: 28px;" class="btn-group bootstrap-select' + multiple + '">' + '<button style="height: 28px; padding: 4px 12px" type="button" class="btn dropdown-toggle selectpicker" data-toggle="dropdown"' + autofocus + '>' + '<span class="filter-option pull-left"></span>&nbsp;' + '<span class="caret"></span>' + '</button>' + '<div class="dropdown-menu open">' + header + searchbox + '<ul class="dropdown-menu inner selectpicker" role="menu">' + '</ul>' + '</div>' + '</div>';
            return $(drop);
        },
        createView: function() {
